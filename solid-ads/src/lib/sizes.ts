...
const SizeMappings: { [slot: string]: [AdSize, AdSize[]] } = {
  "top-above-nav": [[980, 0], Sizes["top-above-nav"].desktop],
  right: [[0, 0], Sizes["right"].desktop],
  "merchandising-high": [[980, 0], Sizes["merchandising-high"].desktop],
};

export { Sizes, SizeMappings };
